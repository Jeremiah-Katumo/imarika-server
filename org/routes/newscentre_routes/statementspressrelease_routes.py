...
from ...cruds.newscentre_cruds import statementspressrelease_cruds
from ...schemas.downloads_schemas import downloadfiles_schemas
from ...database import get_db
from ...utils.auth import get_superadmin

router = APIRouter(
    prefix="/statements_press",
    tags=['News Centre - Statements/Press']
)
...
async def upload_file(
    ...
    for file in files:
        hashed_file = statementspressrelease_cruds.hashed_filename(file)
    ...
    new_download = statementspressrelease_cruds.save_file(db=db, download_file=download_file_data)
    statementspressrelease_cruds.upload_file(downloadFile_id=new_download.downloadFile_id, file=file)
...
async def update_file( 
    ...
    db_file = statementspressrelease_cruds.update_file(
...
async def delete_file(
    ...
    db_file = statementspressrelease_cruds.delete_file(db, filename, category)
...
async def download_file(
    ...
    db_file = statementspressrelease_cruds.get_file(db, downloadFile_id, category)
